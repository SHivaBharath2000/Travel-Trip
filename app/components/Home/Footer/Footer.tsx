...
const Footer = () => {
  return (
    <div className="pt-16 pb-16">
      {/* Top sections */}
      <div className="w-[80%] mx-auto grid grid-cols-1 sm:grid-cols-4 gap-10 items-start">
        {/* 1st part */}
        ...
        <div>
          ...
          <div className="mt-6">
            ...
            <h1 className="text-base font-bold text-blue-950 mt-1">+91 8903396544</h1>
          </div>
          <div className="mt-6">
            <h1 className="text-sm text-gray-600">Our Email</h1>
            <h1 className="text-base font-bold text-blue-950 mt-1">tourist@gmail.com</h1>
          </div>
        </div>
      </div>
  ...
  Copyright © {new Date().getFullYear()} Webdev. All rights reserved        </p>
